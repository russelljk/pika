...
{                                                                                   \
    RaiseException(Exception::ERROR_type, "Invalid self object, expected Window");  \
}                                                                                   \
...
inline WINDOW* GetWindowFrom(Value& v)
{
    ...
    {
        RaiseException(Exception::ERROR_type, "Invalid window object.");
    }
...
UserData* CreateNewWindow(Context* ctx, WINDOW* w)
{
    ...
    if (!window_type)
    {
        RaiseException("Could not create new Window. Window-Type not found. Make sure curses is properly initialized.");
        return 0;
    }
...
pint_t GetCharArg(Value& v)
{
    ...
    RaiseException(Exception::ERROR_type, "Expected character argument");
    return 0;
}
...
PIKA_MODULE(curses, eng, curses)
{
    ...
    {"init",            Static_slk_init,        1, DEF_STRICT, 0 },
    {"attron",          Static_slk_attron,      1, DEF_STRICT, 0 },
    {"attroff",         Static_slk_attroff,     1, DEF_STRICT, 0 },
    {"attrset",         Static_slk_attrset,     1, DEF_STRICT, 0 },
    {"color",           Static_slk_color,       1, DEF_STRICT, 0 },
    
    {"refresh",         Static_slk_refresh,     0, DEF_STRICT, 0 },
    {"noutrefresh",     Static_slk_noutrefresh, 0, DEF_STRICT, 0 },
    {"clear",           Static_slk_clear,       0, DEF_STRICT, 0 },
    {"restore",         Static_slk_restore,     0, DEF_STRICT, 0 },
    {"touch",           Static_slk_touch,       0, DEF_STRICT, 0 },
    {"attr",            Static_slk_attr,        0, DEF_STRICT, 0 },
            
    {"label",           Static_slk_label,       1, DEF_STRICT, 0 },
    {"set",             Static_slk_set,         3, DEF_STRICT, 0 },
    };
    ...
    { "mvaddch",        Window_mvaddch,         3, DEF_STRICT, 0 },  
    { "mvaddstr",       Window_mvaddstr,        3, DEF_STRICT, 0 },
    
    { "addch",          Window_addch,           1, DEF_STRICT, 0 },
    { "addstr",         Window_addstr,          1, DEF_STRICT, 0 },
    
    { "refresh",        Window_wrefresh,        0, DEF_STRICT, 0 },
    { "erase",          Window_werase,          0, DEF_STRICT, 0 },
    { "clear",          Window_wclear,          0, DEF_STRICT, 0 },    
    { "clrtobot",       Window_wclrtobot,       0, DEF_STRICT, 0 },
    { "clrtoeol",       Window_wclrtoeol,       0, DEF_STRICT, 0 },
    { "delch",          Window_wdelch,          0, DEF_STRICT, 0 },
    { "deleteln",       Window_wdeleteln,       0, DEF_STRICT, 0 },
    { "getch",          Window_wgetch,          0, DEF_STRICT, 0 },
    { "inch",           Window_winch,           0, DEF_STRICT, 0 },
    { "insertln",       Window_winsertln,       0, DEF_STRICT, 0 },
    { "standout",       Window_wstandout,       0, DEF_STRICT, 0 },
    { "standend",       Window_wstandend,       0, DEF_STRICT, 0 },
    { "scroll",         Window_scroll,          0, DEF_STRICT, 0 },
    { "syncdown",       Window_wsyncdown,       0, DEF_STRICT, 0 },
    { "syncup",         Window_wsyncup,         0, DEF_STRICT, 0 },
    
    { "mvwin",          Window_mvwin,           2, DEF_STRICT, 0 },
    { "move",           Window_wmove,           2, DEF_STRICT, 0 },
    { "redrawln",       Window_wredrawln,       2, DEF_STRICT, 0 },
    { "setscrreg",      Window_wsetscrreg,      2, DEF_STRICT, 0 },
    { "mvinch",         Window_mvwinch,         2, DEF_STRICT, 0 },
    { "touchline",      Window_touchline,       2, DEF_STRICT, 0 },
    { "resize",         Window_wresize,         2, DEF_STRICT, 0 },
    { "mvderwin",       Window_mvderwin,        2, DEF_STRICT, 0 },
    { "mvdelch",        Window_mvwdelch,        2, DEF_STRICT, 0 },
    { "mvgetch",        Window_mvwgetch,        2, DEF_STRICT, 0 },            
    
    { "getyx",          Window_getyx,           0, DEF_STRICT, 0 },    
    { "begyx",          Window_begyx,           0, DEF_STRICT, 0 },   
    { "maxyx",          Window_maxyx,           0, DEF_STRICT, 0 },      
    
    { "meta",           Window_meta,            1, DEF_STRICT, 0 },
    { "clearok",        Window_clearok,         1, DEF_STRICT, 0 },
    { "nodelay",        Window_nodelay,         1, DEF_STRICT, 0 },
    { "notimeout",      Window_notimeout,       1, DEF_STRICT, 0 },
    { "scrollok",       Window_scrollok,        1, DEF_STRICT, 0 },
    { "intrflush",      Window_intrflush,       1, DEF_STRICT, 0 },
    { "keypad",         Window_keypad,          1, DEF_STRICT, 0 },
    { "leaveok",        Window_leaveok,         1, DEF_STRICT, 0 },
    { "syncok",         Window_syncok,          1, DEF_STRICT, 0 },
    { "idlok",          Window_idlok,           1, DEF_STRICT, 0 },
    { "idcok",          Window_idcok,           1, DEF_STRICT, 0 },
    { "immedok",        Window_immedok,         1, DEF_STRICT, 0 },
    
    { "attron",         Window_wattron,         1, DEF_STRICT, 0 },
    { "attroff",        Window_wattroff,        1, DEF_STRICT, 0 },
    { "attrset",        Window_wattrset,        1, DEF_STRICT, 0 },
    
    { "insdelln",       Window_winsdelln,       1, DEF_STRICT, 0 },
    { "scrl",           Window_wscrl,           1, DEF_STRICT, 0 },
    { "timeout",        Window_wtimeout,        1, DEF_STRICT, 0 },
    { "linetouched?",   Window_is_linetouched,  1, DEF_STRICT, 0 },
    
    { "bkgdset",        Window_wbkgdset,        1, DEF_STRICT, 0 },
    { "bkgd",           Window_wbkgd,           1, DEF_STRICT, 0 },

    { "box",            Window_box,             2, DEF_STRICT, 0 },
    { "vline",          Window_wvline,          2, DEF_STRICT, 0 },
    { "hline",          Window_whline,          2, DEF_STRICT, 0 },
    
    { "mvvline",        Window_mvwvline,        4, DEF_STRICT, 0 },
    { "mvhline",        Window_mvwhline,        4, DEF_STRICT, 0 },
    
    { "border",         Window_wborder,         8, DEF_STRICT, 0 },           
    };
