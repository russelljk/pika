...
struct ConstMethod11: NativeMethodBase
{
    typedef TRet(TClass::*TMETHOD)(TParam0, TParam1, TParam2, TParam3,
                                   TParam4, TParam5, TParam6,
    ...
    ConstMethod11(TMETHOD m): function(m)
    {
        signature[0] = VarType<TParam0>::eSig;
        signature[1] = VarType<TParam1>::eSig;
        signature[2] = VarType<TParam2>::eSig;
...
struct ConstMethod11 < TClass,  void,    TParam0, TParam1, TParam2,
        ...
        : NativeMethodBase
{
    typedef void(TClass::*TMETHOD)(TParam0, TParam1, TParam2, TParam3,
                                   ...
                                   TParam8, TParam9, TParam10) const;
...
struct ConstMethod12: NativeMethodBase
{
    typedef TRet(TClass::*TMETHOD)(TParam0, TParam1, TParam2, TParam3,
                                   TParam4, TParam5, TParam6,
    ...
    ConstMethod12(TMETHOD m): function(m)
    {
        signature[0] = VarType<TParam0>::eSig;
        signature[1] = VarType<TParam1>::eSig;
        signature[2] = VarType<TParam2>::eSig;
...
struct ConstMethod12 < TClass,  void,    TParam0, TParam1, TParam2,
                  TParam3, TParam4, TParam5, TParam6, TParam7, 
        ...
        : NativeMethodBase
{
    typedef void(TClass::*TMETHOD)(TParam0, TParam1, TParam2, TParam3,
                                   TParam4, TParam5, TParam6, TParam7,
                                   TParam8, TParam9, TParam10, TParam11) const;
