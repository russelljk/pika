...
void InitFunctionAPI(Engine* eng)
{
    ...
    .Register(Function_getBytecode,     "getBytecode")
    .Register(Function_getText,         "getText")
    .Register(Function_getLocal,        "getLocal")
    .Register(Function_getLocalCount,   "getLocalCount")
    .Register(Function_printBytecode,   "printBytecode")
    .Register(Function_gen,             "generate")
    .Register(Function_GenerateAs,      "generateAs")
    .Register(Function_call,            "opCall")
    .Register(Function_printLiterals,   "printLiterals")
